  ...
  <div class="ratings" ref="ratingView">
    <div class="ratings-wrapper">
      ...
      <div class="content">
        ...
        <span class="item" v-for="(item, index) in ratings.labels" :key="index" :class="{'highLight':item.label_star>0}">{{item.content}}{{item.label_count}}</span>
        </div>
        <!-- 详细评论内容 -->
        <ul class="rating-list">
            <li class="comment-item" v-for="(comment,index) in selectComments" :key="index">
                ...
                <div class="comment-main">
                    ...
                    <ul class="img-wrapper" v-show="comment.comment_pics.length">
                      <li v-for="(item, index) in comment.comment_pics" :key="index">
                      <img :src="item.url">
                      </li>
                    </ul>
                </div>
