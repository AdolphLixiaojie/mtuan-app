<template>
  <div class="header">
    ...
    <!-- 主题背景 开始-->
    <!-- 方法一：直接绑定 -->
    <!-- <div class="bg-wrapper" :style="'background-image:url(' + this.poiInfo.head_pic_url + ')'">
    </div> -->
    <!-- 上面这里使用backgroud时，background-size和background-position并不会生效，使用background-image时才会生效
    原因是在HTML标签内使用style属性的优先级最高会覆盖style标签内的background属性 -->
    <!-- 方法二：使用coputed计算属性 -->
    ...
    <transition name="bulletin-detail">
      <div class="bulletin-detail" v-show="isShow">
        <div class="detail-wrapper" >
          <!-- 相关内容容器 -->
          <div class="mian-wrapper" :style="detail_bg">
...
<style scoped>
  ...
  .header .bulletin-detail .detail-wrapper .mian-wrapper {
    width: 100%;
    height: 100%;
  ...
  .header .bulletin-detail .detail-wrapper .mian-wrapper .icon{
    width: 60px;
    height: 60px;
    background-size: 135% 100%;
    background-position: center;
  ...
  .header .bulletin-detail .detail-wrapper .mian-wrapper .name{
    font-size: 15px;
    color: white;
    margin-top: 13px;
  }
  /* 星级评价的样式 */
  .header .bulletin-detail .detail-wrapper .mian-wrapper .score{
    height: 10px;
    margin-top: 6px;
    text-align: center;
    font-size: 0;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .score .star{
    display: inline-block;
    margin-right: 7px;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .score span{
    display: inline-block;
    font-size: 10px;
    color: white;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .tip{
    font-size: 11px;
    color: #bababc;
    margin-top: 8px;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .tip i{
    margin: 0 7px;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .time{
    font-size: 11px;
    color: #bababc;
    margin-top: 13px;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .discounts{
    margin-top: 20px;
    padding: 0 20px;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .discounts p{
    padding-top: 20px;
    border-top: 1px solid #bababc;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .discounts img{
    width: 16px;
    height: 16px;
    vertical-align: middle;
  }
  .header .bulletin-detail .detail-wrapper .mian-wrapper .discounts span{
    font-size: 11px;
    line-height: 16px;
    color: white;
  }
