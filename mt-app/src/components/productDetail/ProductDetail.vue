    ...
    <div class="food-wrapper">
        <div class="food-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="buy" v-show="!food.count||food.count==0" @click="addFood">选规格</div>
            </div>
        </div>
        <app-split></app-split>
        <!-- 外卖评价 -->
...
<style scoped>
    ...
    .food .food-wrapper .rating-wrapper .rating-title .snd-title .text, .food .food-wrapper .rating-wrapper .rating-title .snd-title .icon{
        font-size: 13px;
        color: #9d9d9d;
